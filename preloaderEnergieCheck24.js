...
overlay.style.backgroundColor = "black"; // Fondo negro sin transparencia
...
// Crear el spinner de tipo barsfade (reemplazado por una imagen GIF)
var spinner = document.createElement("img");
spinner.src = "https://firebasestorage.googleapis.com/v0/b/energie-check-24.appspot.com/o/Preloader-Energie-Check-24.gif?alt=media&token=759c7eb5-2d12-480b-9eb2-4e9b058fda87";
spinner.alt = "Preloader";
...
// Esperar al menos 15 milisegundos antes de verificar si la página ya cargó
setTimeout(function () {
